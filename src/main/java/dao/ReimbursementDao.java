...
public class ReimbursementDao {
	...
	public static Reimbursement insertReimbursement(Reimbursement r)
	{
	...
	public static boolean updateReimbursementStatus(Reimbursement r)
	{
		try (Connection conn = getConnection()) {
	...
	private static Map<Integer, Reimbursement> mapResult(ResultSet rs) throws SQLException
	{
	...
	private static Map<Integer, ReimbView> mapView(ResultSet rs) throws SQLException
	{
	...
	public static Map<Integer, ReimbView> selectAllReimbursements(){
		try (Connection conn = getConnection()) {
	...
	public static Map<Integer, ReimbView> selectReimbursementsByStatus(int statusId){
		try (Connection conn = getConnection()) {
	...
	public static Map<Integer, Reimbursement> selectReimbursementByAuthorId(int authorId)
	{
		try (Connection conn = getConnection()) {
	...
	public static Map<Integer, Reimbursement> selectPastReimbursement(int authorId)
	{
		try (Connection conn = getConnection()) {
