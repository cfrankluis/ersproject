...
public class UserDao {
	 ...
	 * @param username
	 * @return
	 * 	A User Object containing the username parameter
	 */
	...
	/**
	 * @return
	 * A List of all the financial managers in the database
	 * as User objects containing their first name, last name, and
	 * user ID.
	 */
